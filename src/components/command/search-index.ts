...
export const SUGGESTED_QUERIES: SuggestionChip[] = [
  ...
  { id: "sug-rag", label: "Applied AI Systems", query: "RAG Systems", icon: "⚡" },
    ...
    return [
      {
        ...
        description: "High-level overview of Ankit's career arc, the platforms he builds and leads, awards, and direct download links.",
