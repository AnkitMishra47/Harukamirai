...
export const profile: Profile = {
  ...
  bio: [
    "I'm Ankit, a software engineer working remotely. I work full-time at **OneIT** - an Australian software firm - where I've moved from intern to **Senior Software Engineer** over three years, mostly on backend systems (Java, Spring Boot, Postgres), enterprise integrations (MYOB, CargoWise, Twilio, Xero) and AI in production (1iT-TestRobot, the LLM-driven test runner I'm primary engineer on; RAG on pgvector; MCP tooling). In 2024 I was named **Mid Developer of the Year**. In 2025, I placed **Runner-up for Employee of the Year** - company-wide, across all engineering tiers.",
