...
export const timeline: TimelineEntry[] = [
  ...
  { id: "mca-done", date: "Sep 2024", title: "Master's Degree (MCA) completed", note: "Earned concurrently while shipping production software.", kind: "education" },
  { id: "award-2024", date: "Oct 2024", title: "Associate Senior SWE · Mid Developer of the Year 2024", note: "Awarded across the engineering firm. Stack expanded into Python, Flask, Twilio and Ionic.", kind: "award" },
